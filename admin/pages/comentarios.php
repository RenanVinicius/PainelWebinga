<h1><?php echo str_replace("_", " ", strtoupper($_GET["tbl"])); ?></h1>
<?php 
	$sql = mysql_query("SELECT * FROM ".$_GET["tbl"]." ORDER BY ID DESC");
...
?>
    <table class="table table-hover" style="width:100%;">
		...
		<tr>
			...
			<td>
				<?php 
				if($_GET["tbl"] == "comentarios_pregacoes"){
            ...
            <td>
            	<div class="btn-group">
				  ...
				  <ul class="dropdown-menu">
				    <li><a href="index.php?secao=pages/comentarios&acao=deletar&tbl=<?php echo $_GET["tbl"]; ?>&ID=<?php echo $ln->ID; ?>&foto=<?php echo $ln->foto; ?>" onClick="return confirm('Deseja deletar?');">Deletar</a></li>
				  </ul>
				</div>
...
<?php 
	...
	if(@$_GET["acao"] == "deletar"){
		...
		header("Location: index.php?secao=pages/comentarios&acao=lista&tbl=".$_GET["tbl"]."");
	}
?>
