...
<?php 
	...
	#Titulo da página
	define("TITLE", "SLIDER SECUNDARIO");

	#Nome da tabela no banco
	define("TABLE", "slider_home");
...
<?php 
	...
	if(@$_POST){
		...
		$foto = enviaFoto($_FILES["foto"], TABLE, "crop", "center", "", "640", "270");

		insert(array("foto"), array($foto), "slider_home");
